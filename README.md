...
**Spring Boot Starter for poi**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/poi-spring-boot-starter)](https://github.com/easy-4-java/poi-spring-boot-starter)
...
> **Artifact ID**：`poi-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**poi-spring-boot-starter** is a Spring Boot starter that integrates **poi** for applications using poi. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume poi capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using poi |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for poi |
| JDK | `17` |
| Coordinates | `io.github.easy4j:poi-spring-boot-starter:3.1.x.20260527-SNAPSHOT` |
| Config Prefix | `poi` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers poi beans automatically |
| Property Binding | ✅ Stable | Binds `poi.*` to `PoiProperties` |
...
|---|---|---|:---:|---|:---:|
| `poi.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl poi-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `poi.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/poi-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/poi-spring-boot-starter)
